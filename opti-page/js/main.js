					...
					class d extends l {
						...
						onInit() {
							...
							for (let t = 0; t < 4; t++) {
								let e = 0.15 * Math.cos((t / 4) * Math.PI * 2),
									...
									i = [
										17.9, 12, 8, 5, 3, 2, 1.5, 1.1, 0.8, 0.6, 0.45, 0.3, 0.2, 0.1, 0.05, 0.03, 0.02,
										0.01,
									];
						...
						onUpdate() {
							...
							this.rayCaster &&
								...
								this.sphere &&
									((this.sphere.rotation.y += 0.002), (this.linesMesh3.rotation.y -= 0.004));
...
*/
  ...
  */
		...
		if (document.querySelector(".why") !== null) {
			...
			let whySplitArray = Array.from(
				splitText(document.querySelector(".why__title")).querySelectorAll(".letter")
			);
		...
		if (document.querySelector(".cool") !== null) {
			...
			let coolSplitArray = Array.from(
				splitText(document.querySelector(".cool__title")).querySelectorAll(".letter")
			);
		...
		if (document.querySelector(".cases") !== null) {
			...
			let casesSplitArray = Array.from(
				splitText(document.querySelector(".cases__title")).querySelectorAll(".letter")
			);
			...
			const casesLinesHorizontalBottom = Array.from(
				document.querySelectorAll(".cases__item .line-horizontal-bottom")
			);
		...
		if (document.querySelector(".faq") !== null) {
			...
			let faqSplitArray = Array.from(
				splitText(document.querySelector(".faq__title-main")).querySelectorAll(".letter")
			);
			...
			const faqHorizontalLinesBottom = Array.from(
				document.querySelectorAll(".faq__accordion .line-horizontal-bottom")
			);
		...
		var placeholders = __webpack_require__(963); // CONCATENATED MODULE: ./src/js/_components.js // CONCATENATED MODULE: ./src/js/main.js
	})();
