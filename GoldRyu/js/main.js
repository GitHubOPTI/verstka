...
inputs.forEach(input => {
  input.addEventListener("change", () => {
    ...
    boundCategoryElem.classList.toggle("catalog-hero__container-category-hidden");
  });
});
...
if (categories !== null && hiddenContainer !== null && visibleContainer !== null) {
  categories.forEach(category => {
    category.addEventListener("click", () => {
      ...
      const boundCategoryElem = document.getElementById(boundedCategory);
      const boundFilterElem = document.querySelector(`[data-category-filter="${boundedCategory}"]`).closest(".catalog-hero__item");
      ...
      if (categoryBlocks[categoryBlocks.length - 1] !== boundCategoryElem) {
        categoryBlocks[categoryBlocks.length - 1].style.marginBottom = "0";
      } else {
        categoryBlocks[categoryBlocks.length - 2].style.marginBottom = "0";
      }
    });
  });
}
...
if (designNextBtn !== null) {
  designNextBtn.addEventListener("click", e => {
    ...
    const checkedInputImagePath = designForm.querySelector(".main-design__label-active .main-design__image").getAttribute("src");
