...
changeButtons.forEach(button => {
  button.addEventListener("click", () => {
    ...
    targetSection = document.getElementById(button.getAttribute("data-frame"));
...
const boundCategoryElems = document.querySelectorAll(".catalog-hero__container-category");
...
const categories = document.querySelectorAll(".catalog-hero__container-visible .catalog-hero__container-image");
const hiddenContainer = document.querySelector(".catalog-hero__container-hidden");
const visibleContainer = document.querySelector(".catalog-hero__container-visible");
if (categories !== null && hiddenContainer !== null && visibleContainer !== null) {
  categories.forEach(category => {
    category.addEventListener("click", () => {
      const boundedCategory = category.getAttribute("data-category");
      const boundCategoryElem = document.getElementById(boundedCategory);
      const boundFilterInput = document.querySelector(`[data-category-filter="${boundedCategory}"]`);
      const boundFilterElem = boundFilterInput.closest(".catalog-hero__item");
      boundFilterInput.setAttribute("checked", "checked");
      boundCategoryElem.classList.add("catalog-hero__container-category-first");
      ...
      let categoryBlocks = document.querySelectorAll(".catalog-hero__container-category");
    });
  });
}
...
const videoContainers = document.querySelectorAll(".main-feedback__container-video");
videoContainers.forEach(container => {
  const video = container.querySelector(".main-feedback__video");
  let counter = 0;
  const fullScreenButton = container.querySelector(".main-feedback__button-fullscreen");
  ...
  container.addEventListener("click", () => {
    if (container.classList.contains("main-feedback__container-video-active")) {
      container.classList.remove("main-feedback__container-video-active");
      video.pause();
      if (counter == 0) {
        video.load();
...
var radio_switch = __webpack_require__(848);
...
;// CONCATENATED MODULE: ./src/js/components/sliders.js

core.use([Pagination, EffectCreative, Navigation, Thumb, Manipulation, Autoplay]);
const swiperHero = new core(document.querySelector(".main-hero__slider"), {
  slidesPerView: "auto",
  spaceBetween: 40,
  resistanceRatio: 0,
  speed: 400,
...
const swiperFeedback = new core(document.querySelector(".main-feedback__slider"), {
  slidesPerView: 3,
  spaceBetween: 30,
  speed: 400,
  resistanceRatio: 1,
...
const sliderThumbs = new core(".catalog-item-hero__slider-thumbs .swiper-container", {
  slidesPerView: 3,
  direction: "vertical",
  navigation: {
...
const sliderImages = new core(".catalog-item-hero__slider-images .swiper-container", {
  slidesPerView: 1,
  spaceBetween: 30,
  mousewheel: true,
  navigation: {
...
if (designNextBtn !== null) {
  designNextBtn.addEventListener("click", e => {
    ...
    const checkedInputs = designForm.querySelectorAll(".main-design__label-active .main-design__input");
    const checkedInput = designForm.querySelector(".main-design__label-active");
    const checkedInputImage = checkedInput.querySelector(".main-design__image");
    const checkedInputImagePath = checkedInputImage.getAttribute("src");
    const checkedInputOldPrice = checkedInputImage.getAttribute("data-old-price");
    ...
    if (checkedInputs !== null) {
      ...
      const importedImages = document.querySelectorAll(".main-degign__image-imported");
      importedImages.forEach(importedImage => {
        importedImage.setAttribute("src", formData.img);
      });
      const importedShapes = document.querySelectorAll(".main-design__text-shape");
      importedShapes.forEach(importedShape => {
        importedShape.innerHTML = `Форма: ${formData.shape}`;
      });
      const importedColors = document.querySelectorAll(".main-design__text-color");
      importedColors.forEach(importedColor => {
        importedColor.innerHTML = `Цвет: ${formData.color}`;
      });
      const importedPrice = document.querySelectorAll(".main-design__text-price");
      importedPrice.forEach(importedPrice => {
        importedPrice.innerHTML = `${formData.price} ₽`;
      });
      const importedPriceOld = document.querySelectorAll(".main-design__text-price-old");
...
var maps = __webpack_require__(27);
...
var search_icons = __webpack_require__(986);
;// CONCATENATED MODULE: ./src/js/functions/disable-scroll.js

const disableScroll = () => {
  const fixBlocks = document?.querySelectorAll('.fixed-block');
  const pagePosition = window.scrollY;
  const paddingOffset = `${window.innerWidth - _vars.bodyEl.offsetWidth}px`;
...
if (formSection !== null) {
  ...
  const formsContainersInner = formSection.querySelectorAll(".forms__container-inner");
  ...
  const recoverFormContainer = document.getElementById("recoverFormContainer");
  ...
  newPasswordForm.addEventListener("submit", e => {
    ...
    newPasswordFormContainer.classList.remove("forms__container-inner-hidden");
  });
...
var up_button = __webpack_require__(290);
