/******/ (() => {
	...
	(() => {
		...
		var components_select = __webpack_require__(407); // CONCATENATED MODULE: ./node_modules/ssr-window/ssr-window.esm.js
		/**
		 * SSR Window 4.0.2
    ...
    support
      ...
      `;
		...
		} // CONCATENATED MODULE: ./node_modules/swiper/swiper.esm.js // CONCATENATED MODULE: ./src/js/components/hovers.js
		/**
		 * Swiper 7.4.1
		...
		} // CONCATENATED MODULE: ./src/js/components/table-slider.js
		core.use([Navigation, Pagination, Thumb]);

		let sliderData = [
			{
				user: {
					avatar: "./img/hero-avatar.png",
					name: "Саночкин Олег / вн 249",
			...
			},
			{
				user: {
					avatar: "./img/hero-avatar.png",
					name: "Саночкин Олег / вн 249",
					job: "Руководитель отдела по управлению отделом руководителей",
				},
				statuses: {
					grade: "1.0",
				},
	...
	`;
		...
		makeSlider();
		makeHovers();
		hideLoader(); // CONCATENATED MODULE: ./src/js/_components.js // CONCATENATED MODULE: ./src/js/main.js
	})();
